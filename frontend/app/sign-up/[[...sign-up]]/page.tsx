    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <Card className="max-w-md w-full">
        <CardHeader>
          ...
          <CardDescription>
            Clerk authentication isn't configured, so sign-up is disabled. You're
        ...
        <CardContent className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            To enable real sign-up, set <code className="text-foreground">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</code>
